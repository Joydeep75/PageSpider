...
# This function is responsible for taking the actually content out of the load_page() function and html page,
# into the variable page_contents. This is a string, which is going to contains html, from the pages what spider has
# read.
# We wanted to index all of the words within that content
